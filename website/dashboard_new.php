...
<!-- JOYRIDE INCLUDE FILES -->
<!-- Attach the Joyride CSS file -->
<link rel=" stylesheet" type="text/css" href="../zurb-joyride-9685a1e/joyride-2.1.css">
	...
	<div class="page-sidebar-wrapper">
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				<li class="start" id="searchTitle"><span class="title"><h2 style="text-align: center; color: white">VIBE</h2></span></li>
				...
				<li id="frontend-link" class="tooltips">
					...
					<div class="portlet box purple">
						...
						<div class="portlet-body">
							<div class="table-responsive">
								<table class="table table-striped table-hover" id="tableStopper">
								<thead>
								<tr>
									<th>
										#
