<?php 
    ...
    switch ( $action ) {
  		case 'test':
	    	...
	    	$pic1 = "/img/profpic-sample1.jpg";
	    	$next = "questions.php?action=test";
			$pic2 = "/img/profpic-sample1.jpg";
	    break;
	    default:
		    $pic1 = $_SESSION['pic1'];
			$pic2 = $_SESSION['pic2'];
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<form role="form" class="form-horizontal form-bordered" action="searchresults.php" method="post" name="questionsform">
								...
								<div style="width: 16.66666%; float: left; margin-top: 20px; margin-bottom: 20px"></div>
								<div style="width: 41.66666%; float: left; margin-top: 20px; margin-bottom: 20px; height: 250px">
									<span style="overflow: hidden; margin: 0 auto; display: block; width: 250px; height: 100%">
										<img class="askedQuestion" src=<?php echo $pic2 ?> />
									</span>
								</div>
								<div class="form-actions fluid">
									<div class="col-md-12">
										<div class="col-md-5"><input style="display: block; margin: 0 auto" name="name1" type="submit"  value="<?php echo $_SESSION['Name1'] ?>"class="btn green" /></div>
										<div class="col-md-2"><button style="display: block; margin: 0 auto" type="button" onclick="location.href='/index.php?action=question'" class="btn default">Skip</button></div>
										<div class="col-md-5"><input style="display: block; margin: 0 auto" name="name2" type="submit"  value="<?php echo $_SESSION['Name2'] ?>"class="btn green" /></div>
									</div>
								</div>
							</form>
						</div>
