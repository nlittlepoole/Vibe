...
<div class="widget widget-tabs widget-tabs-vertical row row-merge" id="maps_vector_tabs">
	...
	<div class="widget-head col-md-3 bg-gray">
		<ul class="border-bottom">
			...
			<li><a href="<?php echo getURL(array('page'=>'maps_vector','section'=>'fullscreen')); ?>"><span class="pull-right label label-primary">new</span> Full screen vector map</a></li>
		</ul>
	</div>
	<!-- // Tabs Heading END -->
